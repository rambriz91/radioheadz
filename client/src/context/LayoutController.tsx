...
const LayoutController = createContext<LayoutController>({
  chatVisible: '',
...
export const LayoutControlProvider = ({children}: {children: ReactNode}) => {
  const [chatVisible, setChatVisibility] = useState<LayoutController['chatVisible']>('');
  const [popUpText, setPopUpText] = useState('');
  const [memberListVisible, setShowMembers] = useState<LayoutController['memberListVisible']>('');
